...
class UninstallKey:
    ...
    def remove_context_menu(self, type: str):
        key_path = fr"Software\Classes\SystemFileAssociations\{type}\shell\ConvertImage"
    ...
    def remove_context_menu_to_video_formats(self):
        ...
        for format in formats:
            key_path = fr"Software\Classes\SystemFileAssociations\{format}\shell\ConvertVideo"
